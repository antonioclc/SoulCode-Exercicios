// 01 - Elabore um script que leia dois números e imprima  o resultado das
...
// 03 - Dado que a fórmula para conversão de Fahrenheit para Celsius é C = 5/9 (F – 32),
...
// 04 - Faça um algoritmo que transforme a velocidade fornecida em m/s pelo usuário
...
// 07 - Em uma certificação são feitos 5 exames (I, II, III, IV e V). Escreva um
...
for (const exame of notasDosExames) {
  if (exame >= 70) {
    classificação += 1;
  }
}
...
// 08 - Chama-se ano bissexto o ano ao qual é acrescentado um dia extra, ficando
...
// Um ano é bissexto se ele é divisível por 4. Entretanto, se o ano é divisível por 100,
// ele não é bissexto. Mas, se ele for divisível por 400, ele volta a ser bissexto.
...
// 10 - Escreva um algoritmo que receba dois números reais e um código de seleção
// do usuário. Se o código digitado for 1, faça o algoritmo somar os dois números
// previamente digitados e mostrar o resultado; se o código de seleção for 2, os
// números deverão ser multiplicados; se o código de seleção for 3, o primeiro número
// deve ser dividido pelo segundo.
...
// 11 - Crie um object array com os valores de um veículo, sendo as chaves são marca,
// modelo, cor, ano, valor, renavam, placa, cada um das chaves devem possuir valores.
// Exiba através da body do HTML as informações do veículo:
...
const carro = [{
  marca: 'Fiat', modelo: 'Palio', cor: 'Branco', ano: '2015', renavam: '123456', placa: 'YXZ-1234',
}];
...
// 12 - Crie um array com valores de 10 alunos de sua turma, exiba os valores existentes
// nas posições: 0,5,2,6,9 e 7.
...
// 13 - Crie um array com 5 posições e em cada posição, um object array com as seguintes
// chave/valor (id, nome, telefone, email). Exiba o array via console. e acesse as
// informações do object na posição 3.
